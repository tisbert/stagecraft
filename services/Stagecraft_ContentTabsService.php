...
class Stagecraft_ContentTabsService extends BaseApplicationComponent {
  ...
  public function import($tabDefs, $applyToTabs) {
    ...
    foreach ($tabDefs as $tabname=>$tabDef) {
      ...
      $sectionDefs = craft()->stagecraft_sections->export($sections, $entryTypeIds);
      ...
      craft()->stagecraft_sections->import($sectionDefs);
    }
